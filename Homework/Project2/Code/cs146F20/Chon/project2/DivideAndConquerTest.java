...
/**
 * Tests the Divide and Conquer Algorithm with test cases of 10 and 8, random test cases, and test
 * cases of input sizes: 100, 200, 500, 1000, 2000, 5000, and 10000.
 */
public class DivideAndConquerTest {
    ...
    public void test10() {
        for (int i = 0; i < testNumbers.length; i += 10) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(testNumbers[i]);
            results = daca.findMaximumSubArray(0, testNumbers[0].length - 1);
    ...
    public void moreTest() {
        ...
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(testNumbers[i]);
            results = daca.findMaximumSubArray(0, testNumbers[i].length - 1);
    ...
    public static void runningTimeNumbers() throws IOException {
        DivideAndConquerTest dact = new DivideAndConquerTest();
        dact.setUp();

        System.out.println("Input Size 100 (in ns): " + dact.runningTime100());
        System.out.println("Input Size 200 (in ns): " + dact.runningTime200());
        System.out.println("Input Size 500 (in ns): " + dact.runningTime500());
        System.out.println("Input Size 1000 (in ns): " + dact.runningTime1000());
        System.out.println("Input Size 2000 (in ns): " + dact.runningTime2000());
        System.out.println("Input Size 5000 (in ns): " + dact.runningTime5000());
        System.out.println("Input Size 10000 (in ns): " + dact.runningTime10000());
    }

    public double runningTime100() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(100));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 99);
    ...
    public double runningTime200() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(200));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 199);
            time = System.nanoTime() - time;
            elapsedTime += time;
        }
    ...
    public double runningTime500() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(500));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 499);
            time = System.nanoTime() - time;
            elapsedTime += time;
        }
    ...
    public double runningTime1000() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(1000));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 999);
            time = System.nanoTime() - time;
            elapsedTime += time;
        }
    ...
    public double runningTime2000() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(2000));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 1999);
            time = System.nanoTime() - time;
            elapsedTime += time;
        }
    ...
    public double runningTime5000() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(5000));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 4999);
            time = System.nanoTime() - time;
            elapsedTime += time;
        }
    ...
    public double runningTime10000() {
        elapsedTime = 0;
        for (int i = 0; i < 10; i++) {
            DivideAndConquerAlgorithm daca = new DivideAndConquerAlgorithm(in.createArray(10000));
            time = System.nanoTime();
            results = daca.findMaximumSubArray(0, 9999);
            time = System.nanoTime() - time;
            elapsedTime += time;
        }
